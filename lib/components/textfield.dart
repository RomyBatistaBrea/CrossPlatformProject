            ...
            focusNode: _focusNode,
              child: TextField(
                        ...
                        decoration: InputDecoration(
                          enabledBorder: OutlineInputBorder( //When not focused, this is the border style
                            borderSide:  const BorderSide(color: Color.fromARGB(255, 255, 255, 255)),
                            borderRadius: BorderRadius.circular(50.0),
                          ),

                          focusedBorder: OutlineInputBorder( //When focused, this is the border style
                            borderSide: const BorderSide(color: Color.fromARGB(255, 114, 219, 226)),
                            borderRadius: BorderRadius.circular(50.0),
                          ),
                          ...
                          fillColor: _isFocused ? const Color.fromARGB(50, 170, 170, 170) : const Color.fromARGB(0, 255, 255, 255), 
    
                          filled: true, //The textField will be colored in if True
                          labelText: widget.labelText, //Gets its property value from the constructor
                          labelStyle: //Changes the color of the labelText when focused and not focused
                            _isFocused ? const TextStyle(color: Colors.white, fontSize: 15): const TextStyle(color: Colors.white, fontSize: 17),
                          
                          prefixIcon: widget.prefixIcon,
                          prefixIconColor: _isFocused ?  const Color.fromARGB(255, 114, 219, 226):  Colors.white, //Gets the Icon value from the constructor
              ),
            ),
          ),
    );
