import 'dart:ui';
import 'package:login_page/components/custom_checkbox.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //Entire Screen
    return Scaffold(
      resizeToAvoidBottomInset: false, // Add this line to prevent screen resizing
        ...
        body: Stack(
          children: [
              ...
              child:
                WaveWidget(
                  config: CustomConfig(
                    gradients: [[Colors.blue, Colors.purpleAccent],
                                [const Color.fromARGB(255, 224, 165, 235), const Color.fromARGB(255, 126, 28, 60)],
                                [const Color.fromARGB(255, 74, 133, 163), Colors.deepPurple], 
                                ],
                ...
                // Lines up in column
                  ...
                  children: [
                    ...
                    // logo
                    Container(
                      constraints: const BoxConstraints(maxWidth: 150), // Set the maximum width
                      ...
                      style: TextStyle(
                        ...
                        shadows: [
                          Shadow(
                            ...
                            offset: Offset(0.4, 5), // how much shadow will be shown
                          ),
                        ],
                          fontFamily: "Inter",
                          letterSpacing: 5,
